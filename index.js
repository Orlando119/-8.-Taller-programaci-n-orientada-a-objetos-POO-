...
var Info = /** @class */ (function () {
    ...
    Info.prototype.describe = function () {
        console.log("Tu nombre es  ".concat(this.name));
    };
    return Info;
}());
var Person = /** @class */ (function () {
    ...
    Person.prototype.sayHello = function () {
        return "Hola, soy yo " + this.name;
    };
    return Person;
}());
;
var ciudadano = new Person("Javier", 1.80, 20);
var citizen = new Person("Diana", 1.70, 30);
...
var messi = new Player("primario", "PSG", "Lionel", 1.69, 35);
